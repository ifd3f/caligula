...
//
  ...
  (
    if system == "x86_64-linux" then
      {
        autoescalate-doas = pkgs.callPackage ./autoescalate { escalationTool = "doas"; };
        autoescalate-sudo = pkgs.callPackage ./autoescalate { escalationTool = "sudo"; };
        autoescalate-run0 = pkgs.callPackage ./autoescalate { escalationTool = "run0"; };
