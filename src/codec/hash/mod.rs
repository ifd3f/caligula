...
use base64::Engine;
use digest::Digest;
pub use file::{find_hash_in_standard_files, find_hash_in_user_file};
use serde::{Deserialize, Serialize};

use crate::util::io_graph;
...
macro_rules! generate {
    {
        ...
        impl HashAlg {
            ...
            /// Construct a (dynamic-dispatched) [`io_graph::HashWorker`] for this algorithm
            ...
            pub fn hash_worker<R: io_graph::RecvBytes>(&self) -> Box<dyn io_graph::Worker<R, Output=bytes::Bytes, Error=std::io::Error>> {
                match self {
                    $(Self::$enum_arm => io_graph::worker::HashWorker::<$hash_inner>::new(),)*
                }
            }
...
mod tests {
    ...
    use super::{HashAlg, HashParseError, parse_hash_input};
